  ...
  return (
    <div  className='mx-[30%] my-[10%]'>
      ...
      <div className='mt-10 '>
        ...
        <form>
          <input type="radio" name="diet" value="Vegetarian" className=' ' onChange={() => setDiet('Vegetarian')}/> Vegetarian
          {/* <input type="radio" name="diet" value="Vegan" className='ml-5 '  onChange={() => setDiet('Vegan')}/> Vegan */}
      ...
      <div className='mt-5'>
        <h3  className='font-Roboto text-sm mb-1'>'How often do you find yourself consuming items high in sugar, salt, or processed foods (candies, chips, cakes, burger, pizza)?',
        </h3>
        <div className=''>
          <Select
