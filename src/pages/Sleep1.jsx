...
export default function Sleep1() {
  ...
  const alcoholStatus = [
    { label: 'Never', status: 'Never', value: 'Never' },
    { label: 'drink alcohol occasionally', status: 'drink alcohol occasionally', value: 'drink alcohol occasionally' },
    // { label: 'Consume alcohol occasionally', status: 'Consume alcohol occasionally', value: 'Consume alcohol occasionally' },
    { label: 'drink alcohol frequently (more than 10 drinks per week)', status: 'drink alcohol frequently', value: 'drink alcohol frequently' },
  ]
    ...
    <div className='mx-[30%] my-[5%]'>
      ...
      <Formik
        ...
        validationSchema={Yup.object({
          ...
          phyActEng: Yup.string().required('Required'),
        ...
        <Form>
          <div className='mt-10'>
            <div className='mt-5 fle'>
              ...
              <Field type="number" name="sleep" placeholder="Enter sleep in hours" className='h-8 border border-green-500 px-3 py-2 rounded  focus:outline-none focus:border-green-700 w-1/2' />
            ...
            <div className='mt-5'>
              ...
              <div role="group" aria-labelledby="my-radio-group">
                <label>
                  <Field type="radio" name="phyActEng" value="phyYes" onClick={() => { setPhyActEng(true) }} />
                  Yes
                </label>
                <label className='ml-10'>
                  <Field type="radio" name="phyActEng" value="phyNo" onClick={() => { setPhyActEng(false) }} />
                  No
                </label>
              </div>
